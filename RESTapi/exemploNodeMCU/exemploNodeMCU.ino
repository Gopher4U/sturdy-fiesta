...
//wifi
char nome_wifi[] = "nome_da_rede";
char password_wifi[] = "senha_da_rede";
...
const char* topico = "algum/topico";
...
void callback(char* topic, byte* payload, unsigned int length) {
  Serial.print("Comando recebido em topico: ");
